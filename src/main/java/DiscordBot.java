...
public class DiscordBot extends ListenerAdapter {
    ...
    public static void logCatch(Exception e) {
        //todo: implement how to deal with exceptions here
        e.printStackTrace();
    }

    public static void logCatch(SQLException e, PreparedStatement statement, Throwable t) {
        //todo: implement how to deal with sql exceptions here
        e.printStackTrace();
    }
}